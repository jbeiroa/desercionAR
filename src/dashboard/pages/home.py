            ...
            [
                ...
                dbc.Col(
                    html.Div(
                        [
                            html.Div(
                                [html.H4("Edad"), dcc.Graph(figure={}, id="chart1")]
                            ),
                            html.Div(
                                [
                                    html.H4("Nivel educativo"),
                                    dcc.Graph(figure={}, id="chart2"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Combustible utilizado para cocinar"),
                                    dcc.Graph(figure={}, id="chart3"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Ratio de ocupados/miembros del hogar"),
                                    dcc.Graph(figure={}, id="chart4"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Cdad. total de miembros del hogar"),
                ...
                dbc.Col(
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.H4("Cdad. de miembros menores de 10 años"),
                                    dcc.Graph(figure={}, id="chart6"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Cobertura prepaga"),
                                    dcc.Graph(figure={}, id="chart7"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Cantidad de ambientes del hogar"),
                                    dcc.Graph(figure={}, id="chart8"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Recibe cuotas de alimentos"),
                                    dcc.Graph(figure={}, id="chart9"),
                                ]
                            ),
                            html.Div(
                                [
                                    html.H4("Estado ocupacional"),
...
def update_charts(n_clicks):
    ...
    charts = []
    for i in range(1, 11):
        charts.append(px.histogram(data_frame=X, x=importantes[i - 1], color="DESERTO"))
    return charts
