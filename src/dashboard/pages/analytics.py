...
layout = dbc.Container(
    [
        dbc.Row(
            [
                html.H2(
                    "Histograma y distribución bivariada de la variable seleccionada"
                ),
                dcc.Dropdown(
        ...
        dbc.Row(
            [
                dbc.Col(dcc.Graph(figure=make_hist(df=data), id="histplot"), width=6),
                dbc.Col(
